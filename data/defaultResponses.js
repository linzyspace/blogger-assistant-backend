module.exports = [
  ...
  { keywords: ["deep learning", "neural network"], reply: "Deep Learning is a type of ML using neural networks with many layers to model complex patterns." },
  ...
  { keywords: ["chatbot"], reply: "A chatbot is a program designed to simulate conversation with human users, often using AI or rules-based logic." },
  ...
  { keywords: ["computer vision", "cv"], reply: "Computer Vision is a field of AI that enables machines to interpret and understand visual information from the world." },
